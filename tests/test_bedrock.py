...
def test_bedrock_invoke_mock(use_converse: bool):
    ...
    mock_response = {"text": "Los Angeles International Airport (LAX)", "usage": {"input_tokens": 10, "output_tokens": 5}}
