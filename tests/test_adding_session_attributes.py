...
def test_adding_session_attributes():
    ...
    lex_request: LexRequest[CustomSessionAttributes] = dialog.parse_lex_request(data, CustomSessionAttributes())
    ...
    lex_request.sessionState.sessionAttributes.lex_intent = "FallbackIntent"  # Make sure parent is still here
